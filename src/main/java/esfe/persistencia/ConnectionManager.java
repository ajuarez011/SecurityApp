...
public class ConnectionManager {
     ...
     */
    private static final String STR_CONNECTION = "jdbc:sqlserver://wmst-cat08:1433; " +
            "encrypt=true; " +
            "database=SecurityDB2025; " +
            "trustServerCertificate=true;" +
            "user=Kelloggs;" +
            "password=yjcf1612daniela";
    ...
    /**
     * Este metodo se encarga de establecer la conexión con la base de datos.
    ...
    /**
     * Este metodo se encarga de cerrar la conexión a la base de datos.
    ...
    /**
     * Este metodo estático y sincronizado (`synchronized`) implementa el patrón Singleton.
