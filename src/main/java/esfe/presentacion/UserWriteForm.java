...
public class UserWriteForm extends JDialog {
    ...
    public UserWriteForm(MainForm mainForm, CUD cud, User user) {
        ...
        init(); // Llama al metodo 'init' para inicializar y configure the form based on 'cud'
    ...
    private void init() {
        ...
        // Llama al metodo 'setValuesControls' para llenar los campos del formulario
            ...
            if (res) {
                ...
                switch (this.cud) {
                    case CREATE:
                        ...
                        // Llama al metodo 'create' de userDAO para persistir el nuevo usuario (this.en).
                    ...
                    case UPDATE:
                        ...
                        // Llama al metodo 'update' de userDAO para guardar los cambios del usuario (this.en).
                    ...
                    case DELETE:
                        ...
                        // Llama al metodo 'delete' de userDAO para eliminar el usuario (this.en).
