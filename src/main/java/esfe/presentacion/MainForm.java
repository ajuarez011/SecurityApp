...
public class MainForm extends JFrame {
    private User userAuthenticated; // Declaración de una variable de instancia llamada 'userAutenticate' de tipo User. Esta variable se utilizará para almacenar la información del usuario que ha sido autenticado en el sistema.
    ...
    public MainForm(){
        ...
        createMenu(); // Llama al metodo 'createMenu()' para crear y agregar la barra de menú a la ventana principal.
    }
