...
public class ChangePasswordForm extends JDialog {
    ...
    public ChangePasswordForm(MainForm mainForm) {
        ...
        txtEmail.setText(mainForm.getUserAuthenticated().getEmail()); // Pre-carga el campo de correo electrónico con el email del usuario autenticado en la ventana principal.
        ...
        // Agrega un ActionListener al botón btnChangePassword para que ejecute el metodo changePassword() cuando se haga clic.
    ...
    private void changePassword() {
        ...
        try {
            ...
            User userAut = mainForm.getUserAuthenticated();
