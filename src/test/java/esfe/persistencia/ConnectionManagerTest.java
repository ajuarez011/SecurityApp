...
class ConnectionManagerTest {
    ...
    void tearDown() throws SQLException {
        // Se ejecuta después de cada metodo de prueba.
    ...
    void connect() throws SQLException {
        ...
        // El metodo isClosed() devuelve true si la conexión está cerrada, por lo que assertFalse espera que devuelva false.
