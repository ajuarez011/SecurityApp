...
import org.junit.jupiter.api.BeforeEach; // Anotación para indicar que el metodo se ejecuta antes de cada metodo de prueba.
import org.junit.jupiter.api.Test;       // Anotación para indicar que el metodo es un caso de prueba.
...
class UserDAOTest {
    ...
    @BeforeEach
    void setUp(){
        // Metodo que se ejecuta antes de cada metodo de prueba (@Test).
    ...
    private User create(User user) throws SQLException{
        // Llama al metodo 'create' del UserDAO para persistir el usuario en la base de datos (simulada).
    ...
    private void update(User user) throws SQLException{
        ...
        // Llama al metodo 'update' del UserDAO para actualizar el usuario en la base de datos (simulada).
        ...
        // Llama al metodo 'getById' para verificar que los cambios se persistieron correctamente.
        // Aunque el metodo 'getById' ya tiene sus propias aserciones, esta llamada adicional
    ...
    private void getById(User user) throws SQLException {
        // Llama al metodo 'getById' del UserDAO para obtener un usuario por su ID.
    ...
    private void search(User user) throws SQLException {
        // Llama al metodo 'search' del UserDAO para buscar usuarios por nombre.
    ...
    private void delete(User user) throws SQLException{
        // Llama al metodo 'delete' del UserDAO para eliminar un usuario por su ID.
        ...
        // después de la eliminación (el metodo 'getById' debería retornar null).
    ...
    private void autenticate(User user) throws SQLException {
        // Llama al metodo 'authenticate' del UserDAO para intentar autenticar un usuario.
    ...
    private void autenticacionFails(User user) throws SQLException {
        ...
        // lo cual se espera que se represente con el metodo 'authenticate'
    ...
    private void updatePassword(User user) throws SQLException{
        // Llama al metodo 'updatePassword' del UserDAO para actualizar la contraseña del usuario.
        ...
        // Llama al metodo 'autenticate' para verificar que la nueva contraseña es válida
    ...
    void testUserDAO() throws SQLException {
        ...
        // Llama al metodo 'create' para persistir el usuario de prueba en la base de datos (simulada) y verifica su creación.
        User testUser = create(user);

        // Llama al metodo 'update' para modificar los datos del usuario de prueba y verifica la actualización.
        update(testUser);

        // Llama al metodo 'search' para buscar usuarios por el nombre del usuario de prueba y verifica que se encuentre.
        search(testUser);
        ...
        // Llama al metodo 'autenticate' para verificar que el usuario puede autenticarse con sus credenciales correctas.
        ...
        updatePassword(testUser); // Llama al metodo para actualizar la contraseña en la base de datos.
        ...
        // Llama al metodo 'delete' para eliminar el usuario de prueba de la base de datos y verifica la eliminación.
        delete(testUser);
    }
    @Test
